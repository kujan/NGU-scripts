...
class Ui_OptionsWindow(object):
    def setupUi(self, OptionsWindow):
        ...
        self.w_duration_2 = QtWidgets.QWidget(self.centralwidget)
        self.w_duration_2.setObjectName("w_duration_2")
        self.w_duration = QtWidgets.QHBoxLayout(self.w_duration_2)
        self.w_duration.setObjectName("w_duration")
        self.label_duration = QtWidgets.QLabel(self.w_duration_2)
        ...
        self.line_duration = QtWidgets.QLineEdit(self.w_duration_2)
        ...
        self.verticalLayout_2.addWidget(self.w_duration_2)
        ...
        self.w_force.addItem(spacerItem6)
    ...
    def retranslateUi(self, OptionsWindow):
        ...
        self.check_major.setText(_translate("OptionsWindow", "PH - Do major quests"))
        self.check_subcontract.setText(_translate("OptionsWindow", "PH - Subcontract"))
