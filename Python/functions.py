...
def window_enumeration_handler(hwnd, top_windows):
  """Iterate over active windows and function for gethwnd()."""
...
def image_search(x_start, y_start, x_end, y_end, image):
  """Search the screen for the supplied picture, returns a tuple with x,y- coordinates.
...
sellout_shop = image_search(0, 0, 1920, 1080, "sellout.png") # This requires you to have the file "sellout.png"
