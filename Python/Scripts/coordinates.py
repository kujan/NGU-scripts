...
MENU_QUESTING = Pixel(MENU_OFFSET_X, 455)
MENU_HACKS = Pixel(MENU_OFFSET_X, 485)
MENU_WISHES = Pixel(MENU_OFFSET_X, 515)
MENU_ITEMS = {
...
BREAKDOWN_MISC_SCROLL_DRAG_END = Pixel(956, 158)
...
WISH_E_ADD = Pixel(595, 220)
WISH_M_ADD = Pixel(725, 220)
