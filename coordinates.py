...
NGU_BAR_GRAY = "FAFAFA"
INVENTORY_SANITY = ColorPixel(919, 17, '050505')
...
INVENTORY_AREA = OCRBox(326, 304, 926, 554)
INVENTORY_SLOT_WIDTH = 50
INVENTORY_SLOT_HEIGHT = 50
INVENTORY_PAGE_1 = Pixel(358, 575)
...
CHALLENGEOFFSET = 30
OCR_REBIRTH_TIME = OCRBox(14, 388, 161, 407)
...
MAGIC_MENU = Pixel(420, 110)
ADVENTURE_MENU = Pixel(500, 110)
RICH_MENU = Pixel(730, 110)
