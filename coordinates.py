...
MENU_BSC_TRAINING = Pixel(MENU_OFFSET_X, 28)
...
MENU_ITEMS = {
    ...
    'advtraining': MENU_ADV_TRAINING, 'bsctraining': MENU_BSC_TRAINING, 'timemachine': MENU_TIME_MACHINE,
...
BSC_TRAINING_IDLE = Pixel(835, 138)
BSC_TRAINING_BLOCK = Pixel(836, 379)
