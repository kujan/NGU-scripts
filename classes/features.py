...
class Adventure:
    ...
    @staticmethod
    def itopod_snipe(duration, auto=False, thread=None):
        ...
        if thread: thread.send_dict({"task": "Sniping I.T.O.P.O.D"})
